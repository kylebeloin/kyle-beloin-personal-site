      ...
      <div className="scroller">
        <Container visible={visible}>
          ...
          <img
            ...
            src="https://images.unsplash.com/photo-1518791841217-8f162f1e1131?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=150&q=60"
            alt="user"
          />
        ...
        {/* Home Content */}
        <Container
          className={`${layout["bg__color--inverse"]}`}
          visible={true}
          style={{ "--container-height": "25vh" } as React.CSSProperties}
        >
